...
public class G14HM4
{
    ...
    {
       long start, end; //for the evaluation of execution time of a Round
        ...
        //Compute the sum of all the distances of a point from the center of its cluster
        double objective_funtion = pointset.map(x->{

            //Evaluate the cluster to which a point belongs
            ...
            //Return the distance of the point from the center of its cluster
            return best_dist;
        }).reduce((x,y)-> x+y);
        end = System.currentTimeMillis();
        ...
        //return the obj function = (sum of distances)/(number of points in the dataset)
